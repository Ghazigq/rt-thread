 ...
 *****************************************************************************/
en_result_t __attribute__((section(".pre_flash"))) Flash_Write8(uint32_t u32Addr, uint8_t pu8Data[], uint32_t u32Len)
{
    en_result_t             enResult = Error;    
 ...
 ** \retval ErrorInvalidMode      操作模式无效
 *****************************************************************************/
en_result_t __attribute__((section(".pre_flash"))) Flash_SectorErase(uint32_t u32SectorAddr)
{
 ...
 ** \retval Error                 配置失败 
 *****************************************************************************/
en_result_t __attribute__((section(".pre_flash"))) Flash_OpModeConfig(en_flash_op_mode_t enFlashOpMode)
{
    en_result_t enResult = Error;
 ...
 ** \retval Null                               
 *****************************************************************************/
en_result_t __attribute__((section(".pre_flash"))) Flash_LockAll(void)
{
    en_result_t enResult = Error;
 ...
 ** \retval Error       加锁失败                            
 *****************************************************************************/
en_result_t __attribute__((section(".pre_flash"))) Flash_UnlockAll(void)
{
    en_result_t enResult = Error;
 ...
 ** \retval Error       设置失败                                
 *****************************************************************************/
en_result_t __attribute__((section(".pre_flash"))) Flash_WaitCycle(en_flash_waitcycle_t enWaitCycle)
{
    en_result_t enResult = Error;
