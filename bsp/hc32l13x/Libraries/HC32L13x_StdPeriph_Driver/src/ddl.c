...
void delay1ms(uint32_t u32Cnt)
{
    ...
    start = SysTick->VAL;
    reload = SysTick->LOAD;
    us_tick = SystemCoreClock / 1000UL;
...
void delay100us(uint32_t u32Cnt)
{
    ...
    start = SysTick->VAL;
    reload = SysTick->LOAD;
    us_tick = SystemCoreClock / 10000UL;
    ...
    while (delta < us_tick * u32Cnt * 100);
}
...
void delay10us(uint32_t u32Cnt)
{
    ...
    start = SysTick->VAL;
    reload = SysTick->LOAD;
    us_tick = SystemCoreClock / 100000UL;
