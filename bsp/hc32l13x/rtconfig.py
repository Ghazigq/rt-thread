...
if PLATFORM == 'gcc':
    ...
    DEVICE = '  -mcpu=cortex-m0plus -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=soft -ffunction-sections -fdata-sections'
    CFLAGS = DEVICE + ' -g -Wall -D__DEBUG -DUSE_DDL_DRIVER -D__ASSEMBLY__ -D__FPU_USED -D__VTOR_PRESENT'
    ...
    CFLAGS = DEVICE + ' --apcs=interwork -DUSE_DDL_DRIVER -D__DEBUG'
    AFLAGS = DEVICE
